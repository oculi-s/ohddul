...
const PredBlock2 = ({ price }) => {
    ...
    return <div className={styles.box}>
        ...
        오/떨 맞추기를 선택하시면 각각 오름과 떨어짐을, 가격 맞추기를 선택하시면 목표 가격을 맞추실 수 있습니다.<br />
        모든 예측의 채점은 <span className='red'>예측이 일어난 날 자정</span>
        에 이루어집니다.
        <h4>오/떨 맞추기</h4>
        <div className={styles.predWrap}>
            <PredBar {...{
                name,
                code, last: price[code], testing: true, defaultType: 1, help: false
            }} />
        </div>
        ...
        <div className={styles.predWrap}>
            <PredBar {...{
                name,
                code, last: price[code], testing: true, defaultType: 2, help: false
            }} />
        </div>
